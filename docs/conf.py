...
# of the sidebar.
html_logo = "images/radiometry-logo.png"

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "images/radiometry-logo-favicon.ico"
...
man_pages = [
    (master_doc, "radiometry", "radiometry Documentation", [author], 1)
]
